...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\nhtfx\\OneDrive\\Документы\\работа\\twitch\\twitch-backend\\prisma\\generated",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\nhtfx\\OneDrive\\Документы\\работа\\twitch\\twitch-backend\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://postgres:123456@localhost:5434/postgres"
      }
    }
  },
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n  output   = \"./generated/\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"POSTGRES_URL\")\n}\n\nmodel User {\n  id          String  @id @default(uuid())\n  email       String  @unique\n  password    String\n  username    String  @unique\n  displayName String  @map(\"display_name\")\n  avatar      String?\n  bio         String?\n\n  createdAt DateTime @default(now()) @map(\"created_at\")\n  updatedAt DateTime @updatedAt @map(\"updated_at\")\n\n  @@map(\"users\")\n}\n",
  "inlineSchemaHash": "5894a7aa8387663d8a2af3380f4729cbaa9e4f2ea7475800c3436f47057601d6",
  "copyEngine": true
}
